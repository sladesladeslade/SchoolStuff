...
% this is not optimized, idc, brute force wins
pos = [];
xposc10 = Xlo;
yposc10 = Ylo;
% fig1 10 deg cp
for i = 1:length(Vlo_10)
    if Vlo_10(i) > 0
        pos(i) = i;
    end
end
...
hold on
axis equal
quiver(Xup, Yup, Uup_10, Vup_10, "color", "black", "LineWidth", 1);
quiver(xposc10, yposc10, Ulo_10, Vlo_10, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_0_cw, Vup_0_cw, "color", "black", "LineWidth", 1);
quiver(Xlo, Ylo, Ulo_0_cw, Vlo_0_cw, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_8_cw, Vup_8_cw, "color", "black", "LineWidth", 1);
quiver(Xlo, Ylo, Ulo_8_cw, Vlo_8_cw, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_8_cn, Vup_8_cn, "color", "black", "LineWidth", 1);
quiver(Xlo, yposc8, Ulo_8_cn, Vlo_8_cn, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_10_cw, Vup_10_cw, "color", "black", "LineWidth", 1);
quiver(Xlo, Ylo, Ulo_10_cw, Vlo_10_cw, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_10_cn, Vup_10_cn, "color", "black", "LineWidth", 1);
quiver(Xlo, yposc102, Ulo_10_cn, Vlo_10_cn, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_12_cw, Vup_12_cw, "color", "black", "LineWidth", 1);
quiver(Xlo, Ylo, Ulo_12_cw, Vlo_12_cw, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
...
hold on
axis equal
quiver(Xup, Yup, Uup_12_cn, Vup_12_cn, "color", "black", "LineWidth", 1);
quiver(Xlo, yposc12, Ulo_12_cn, Vlo_12_cn, "color", "black", "LineWidth", 1);
plot(Xup, Yup, "color", "black", "LineWidth", 1);
plot(Xlo, Ylo, "color", "black", "LineWidth", 1);
